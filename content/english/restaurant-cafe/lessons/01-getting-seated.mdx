...
Trong cảnh vào quán, "Could" là modal động từ xuất hiện nhiều nhất — không phải ngẫu nhiên, mà vì nó mã hoá mức độ lịch sự vừa đủ: không quá trang trọng như "May I", không quá thẳng như "Can I" hay mệnh lệnh thức.

<Grammar
  point={`"Could" — modal yêu cầu lịch sự`}
  structure={`Could + I/we + base verb + (object)?`}
  examples={[
    { en: "Could I get a still water to start?", vi: "Cho tôi một cốc nước thường để bắt đầu nhé?" },
    { en: "Could we have a few more minutes with the menu?", vi: "Cho chúng tôi xem thực đơn thêm vài phút nữa nhé?" },
    { en: "Could we sit by the window, if possible?", vi: "Cho chúng tôi ngồi cạnh cửa sổ được không, nếu có thể?" },
    { en: "Could we have a booth instead of a table?", vi: "Cho chúng tôi bàn ghế tựa cao thay vì bàn thường được không?" },
    { en: "Could I just get a tap water for now?", vi: "Tạm thời cho tôi một cốc nước máy được không?" },
  ]}
  contrast={`"Could I…?" lịch sự và trung tính nhất. "Can I…?" thân mật hơn, hợp với quán bình dân. Còn "Give me…" là dạng mệnh lệnh — nghe thô trong ngữ cảnh nhà hàng và nên tránh hoàn toàn.`}
/>
